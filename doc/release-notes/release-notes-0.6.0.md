...
Unobtanium-Qt can display and save QR codes for sending
...
versions of Unobtanium-Qt/bitcoind.
...
Unobtanium-Qt's initial splash screen
...
opening/launching Unobtanium-Qt is available only on Linux,
and only if you configure your desktop to launch
Unobtanium-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Unobtanium-Qt window to start
payment.
...
It is expected that future releases of Unobtanium-Qt
