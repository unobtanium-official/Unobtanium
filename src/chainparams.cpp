...
static const Checkpoints::CCheckpointData data = {
        ...
        680219,     // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams() {
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB1)(0x1D).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAC)(0xE3).convert_to_container<std::vector<unsigned char> >();
