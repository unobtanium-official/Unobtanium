...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("unobtanium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  unobtanium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unobtanium transaction") + "\n" +
              "  unobtanium-tx [options] -create [commands]   " + _("Create hex-encoded unobtanium transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded unobtanium transaction
