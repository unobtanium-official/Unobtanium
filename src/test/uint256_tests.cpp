...
BOOST_AUTO_TEST_CASE( conversion )
{
    ...
    BOOST_CHECK(0 == ZeroL);
    BOOST_CHECK(1 == OneL);
    BOOST_CHECK(uint256(R1L.GetHex()) == R1L);
    BOOST_CHECK(uint256(R2L.GetHex()) == R2L);
    BOOST_CHECK(R1L.GetHex() == R1L.GetHex());
    BOOST_CHECK(R2L.GetHex() == R2L.GetHex());
}
